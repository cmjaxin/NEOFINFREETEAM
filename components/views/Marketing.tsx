...
import { wrapText, drawImageWhite, renderRateGraphic, EHL_LOGO_DATA, NEO_LOGO_DATA } from '@/lib/rateGraphicCanvas'
...
async function renderPageToCanvas(canvas: HTMLCanvasElement, page: TplPage, values: FieldValues, w: number, h: number, opts: { qrUrl?: string } = {}) {
  ...
  if (page.blur_bg) {
    await renderRateGraphic(canvas, values, {
      bgUrl: values.property_image,
      qrUrl: opts.qrUrl,
