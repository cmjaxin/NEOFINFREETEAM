...
<div class="main">
  ...
  <div class="left">
    ...
    <div class="tca-card">
      ...
      ${page.tca_screenshot ? `<div class="tca-img"><img src="${page.tca_screenshot}" alt="Total Cost Analysis" /></div>` : `<div class="tca-placeholder"><div style="font-size:28px;opacity:0.4">📊</div><div>Upload a TCA screenshot in the listing presentation editor</div></div>`}
    </div>
  </div>
